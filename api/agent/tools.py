            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "card_name": {
                        ...
                        "description": (
                            "クレジットカード払い時のカード名。"
                            "ユーザーがカード名を明示した場合のみ設定する。"
                            "省略した場合はシステムがデフォルトカードを自動補完する。"
                        ),
                    },
                    "person": {
                        "type": "string",
    ...
    # === 支払方法・カード管理 ===
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "「支払方法の一覧を見せて」や、"
                "ユーザーが使った支払方法が登録済みかどうか確認するときに使う。"
                "カード払い（クレジットカード・デフォルトカード）の確認には使わないこと。"
                "QUICPay・PayPay等のグループ型支払方法のデフォルト解決にのみ使う。"
            ),
            "parameters": {
                "type": "object",
                "properties": {
